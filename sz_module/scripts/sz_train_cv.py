...
class CoreAlgorithm_cv():
    ...
    def init(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterEnum(self.STRING3, 'CV method', options=['random CV','spatial CV','temporal CV (Time Series Split)','temporal CV (Leave One Out)'], allowMultiple=False, usesStaticStrings=False, defaultValue=[]))
