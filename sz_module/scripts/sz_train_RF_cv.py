...
class RFcvAlgorithm(QgsProcessingAlgorithm):
    INPUT = 'covariates'
    STRING = 'field1'
    #STRING1 = 'field2'
    STRING2 = 'fieldlsd'
    ...
    def shortHelpString(self):
        return self.tr("This function apply Random Forest to calculate susceptibility. It allows to cross-validate the analysis by k-fold cross-validation method. If you want just do fitting put k-fold equal to one")
    ...
    def RF(self,classifier,X,y,train,test):
